...
Or drag <a href="javascript:(function(){ cb = function(){ create_spritz();}; var script=document.createElement('SCRIPT');script.src='https://msbarry.github.io/OpenSpritz/spritz.js?callback=cb?callback=cb'; script.onload=cb; document.body.appendChild(script);})();">this</a> to your bookmarks
...
The best way to contribute is to start a new ticket, or to work on an existing ticket. If you find a website which doesn't work with OpenSpritz, [add it to this ticket](https://github.com/msbarry/OpenSpritz/issues/8) so that it can be diagnosed and fixed.
...
* [Rich Jones](https://github.com/msbarry)
